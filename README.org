...
| Transition | 2 | F \wedge C0 \wedge C1 \wedge C0' \Rightarrow \exists X1'\forall O1.(F' \wedge C1') |
| Property   | 1 | C \wedge \neg P \Rightarrow \exists X'\forall O.(C' \wedge \neg P')            |
| Base       | 0 | R' \wedge C' \Rightarrow P'                             |
| Step       | 1 | \forall O.(P0' \vee \neg C0') \wedge C0' \wedge F' \wedge C1' \Rightarrow P1' |
