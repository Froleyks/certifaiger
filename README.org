...
They can include a section in the comments to express the mapping of shared latches:
#+begin_example
c
...
While not necessary, it is recommended to include some identifying information about the corresponding model after the number of shared latches.
